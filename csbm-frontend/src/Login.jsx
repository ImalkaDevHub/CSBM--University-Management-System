    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            const userData = {
                ...
                role: activeTab.toUpperCase() // Use currently selected tab as the desired role
            };
            ...
            message.error(error.code === 'auth/popup-closed-by-user' 
                ? 'Sign-in cancelled.' 
                ...
                <div className="w-full max-w-[420px] bg-white p-8 sm:p-10 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <button 
                            ...
                            disabled={loading}
                            className="flex items-center justify-center py-2.5 px-4 bg-white border border-slate-200 rounded-xl text-sm font-bold text-slate-700 hover:bg-slate-50 hover:border-slate-300 transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {loading ? (
